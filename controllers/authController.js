 ...
 const registerController=async(req,res)=>{
    try{
        ...
        if(!answer){
         ...
         // check for existing same email user
        ...
        res.status(500).send({
            success:false,
            message:'error in registreation',
            error,
        })
...
module.exports={registerController,orderStatusController,getAllOrdersController,getOrdersController,updateProfileController,loginController,testController,forgotPasswordController};